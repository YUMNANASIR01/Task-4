          ...
          {products.map((product: Product, index: number) => (
            <Card key={index} className="group relative overflow-hidden shadow-md">
              ...
              <CardFooter className="flex flex-col items-start gap-4 p-4">
                ...
                <Link href={`/shop/id?id=${product._id}&title=${product.title}&price=${product.price}&imageUrl=${product.imageUrl}&description=${product.description}&discountPercentage=${product.discountPercentage}&isNew=${product.isNew}&tags=${product.tags}`}>
